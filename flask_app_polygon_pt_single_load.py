...
# Move argparse and model loading outside of your endpoint to ensure it only happens once
...
parser.add_argument("--model_threshold", type=float, default=0.9, help="Liveness threshold")
